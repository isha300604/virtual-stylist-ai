...
const Closet: React.FC<ClosetProps> = ({ items, onRemove, onNavigateHome }) => {
  if (items.length === 0) {
    return (
      <div className="max-w-4xl mx-auto py-24 px-6 text-center animate-in fade-in duration-700">
        ...
        <p className="text-gray-500 mb-10 max-w-md mx-auto">
          Start styling your clothes and save your favorite generated looks here to build your personal virtual wardrobe.
        </p>
        <button 
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-6 animate-in fade-in duration-700">
      <div className="flex justify-between items-end mb-16">
        <div>
          <h2 className="text-5xl font-serif mb-3 tracking-tight">My Closet</h2>
          <p className="text-gray-500 text-lg">Your curated archive of personalized styling sessions.</p>
        </div>
        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest bg-gray-100 px-4 py-2 rounded-full">
          {items.length} {items.length === 1 ? 'Saved Look' : 'Saved Looks'}
        </div>
      </div>
